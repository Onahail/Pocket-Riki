...
STRINGS.UI =
{
    ...
    HUD =
    {
        ...
        DEATH_ANNOUNCEMENT_2_ROBOT = ". It became a spooky ghost!",
        ...
        GHOST_DEATH_ANNOUNCEMENT_ROBOT = "lost all of its approximation of humanity and is gone forever.",
    ...
    SERVERLISTINGSCREEN =
    {
        ...
        MODS_HIDDEN_MISMATCH = "Mods list is hidden due to a version mismatch.",
        MODS_HIDDEN_LAN = "The mods list isn't visible in LAN mode. Why not go over and ask your friend?",
        CHAR_AGE_1 = "Day ",
        CHAR_AGE_2 = "",
    ...
    {
        SURVIVAL = "Survival",
        SURVIVAL_TOOLTIP = "Cooperative survival. Dead players cause sanity drain for all.",
        WILDERNESS = "Wilderness",
        WILDERNESS_TOOLTIP = "No resurrection. Careful out there.",
        ENDLESS = "Endless",
        ENDLESS_TOOLTIP = "Resurrection always available via Jury-Rigged Portal.",
        CUSTOM = "Custom",
    },
    ...
    SERVERADMINSCREEN = 
    {
        ...
        CLEAR_PLAYERS = "Delete All",
        UNDO_PLAYERS = "Undo All",        
        PLAYER_DETAILS = "Details",
        PLAYER_PROFILE = "Steam Profile",
        ...
        DELETE_ENTRY_TITLE = "Delete Player?",
        DELETE_ENTRY_BODY = "Do you want to delete \"",
        DELETE_ENTRY_BODY_2 = "\" from your ban list?",
        CLEAR_LIST_TITLE = "Delete all?",
        CLEAR_LIST_BODY = "Do you want to delete all banned players?",
        RESTORE_SNAPSHOT_HEADER = "Restore %s",
        RESTORE_SNAPSHOT_BODY = "Do you want to restore the selected snapshot? You will lose all changes to the world past that day, as well as all subsequent snapshots. This cannot be undone.",
    ...
    CONTROLSSCREEN=
    {
        ...
        INPUTS = { 
            ...
            [7] = {
                ...
                "\144",--"Left Thumb Down",
                "\143",--"Left Thumb Up",
                "\149",--"Right Touch Left",
                "\150",--"Right Touch Right",
                "\148",--"Right Touch Down",
                "\147",--"Right Touch Up",
            },
            -- DualShock4 on PC
            [8] = {
                ...
                "\165",--"DPad Right"
                "\155",--"Options (Start)",
                "\155",--"Back" but not really. It's the Share button which looks the same as the Options button
                "\157",--"L3"
                "\160",--"R3"
                "\158",--"L1",
                "\161",--"R1"
                ...
                -- Analog          
                "\169",--"Left Thumb Left",
                "\170",--"Left Thumb Right",
                "\167",--"Left Thumb Up",
                "\168",--"Left Thumb Down",
                "\173",--"Right Thumb Left",
                "\174",--"Right Thumb Right",
                "\159",--"Left Trigger",
                "\159",--"Left Trigger",
                "\162",--"Right Trigger",
                "\162",--"Right Trigger",
                "\171",--"Right Thumb Up",
                "\172",--"Right Thumb Down",
            },
            --Unknown
            [9] = {
                "Unknown",
